...
# Streamlit login session management
...
# Login Page UI
def login_page():
    st.set_page_config(page_title="Login | Stock Prediction", layout="centered")
    st.title("🔐 Welcome to Stock Market Prediction Dashboard")

    menu = st.radio("Choose Action", ["Login", "Sign Up"], horizontal=True)
    ...
    if menu == "Login":
        ...
        if st.button("Sign Up"):
            ...
            elif new_user.strip() == "" or new_password.strip() == "":
